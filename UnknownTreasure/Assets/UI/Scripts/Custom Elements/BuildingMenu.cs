...
{
    public class BuildingMenu : VisualElement, INotifyValueChanged<(bool, string)>
    {
        ...
        public new class UxmlFactory: UxmlFactory<BuildingMenu, UxmlTraits>{ }
        ...
        public new class UxmlTraits: VisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                ate.Clear();
                VisualTreeAsset vt = Resources.Load<VisualTreeAsset>("UI Documents/BuildingMenu");
